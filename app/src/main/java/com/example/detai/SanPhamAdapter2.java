...
public class SanPhamAdapter2 extends RecyclerView.Adapter<SanPhamAdapter2.SamPhamViewHolder> {
    private ArrayList<SanPham> list = new ArrayList<>();
    private Context context;
    @NonNull
    @Override
    public SamPhamViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_view_s2,parent,false);
        SamPhamViewHolder samPhamViewHolder = new SamPhamViewHolder(view);
        return samPhamViewHolder;
    }

    public SanPhamAdapter2(ArrayList<SanPham> list, Context context) {
        this.list = list;
        this.context = context;
    }

    @Override
    public void onBindViewHolder(@NonNull SanPhamAdapter2.SamPhamViewHolder holder, int position) {
