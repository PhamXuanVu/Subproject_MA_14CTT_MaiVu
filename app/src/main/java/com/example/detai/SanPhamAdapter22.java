...
public class SanPhamAdapter22 extends RecyclerView.Adapter<SanPhamAdapter22.SamPhamViewHolder> {
    private ArrayList<SanPham> list = new ArrayList<>();
    private Context context;
    @NonNull
    @Override
    public SamPhamViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_view_s22,parent,false);
        SamPhamViewHolder samPhamViewHolder = new SamPhamViewHolder(view);
        return samPhamViewHolder;
    }

    public SanPhamAdapter22(ArrayList<SanPham> list, Context context) {
        this.list = list;
        this.context = context;
    }

    @Override
    public void onBindViewHolder(@NonNull SanPhamAdapter22.SamPhamViewHolder holder, int position) {
